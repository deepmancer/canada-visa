...
\begin{figure}[ht]
  \centering
  \includegraphics[page=1, width=0.8\textwidth]{../application-docs/applicant/employment/company-1/insurance-records/official-translations.pdf}
...
\begin{figure}[ht]
  \centering
  \includegraphics[page=1, width=0.8\textwidth]{../application-docs/applicant/employment/company-1/employment-letter.pdf}
